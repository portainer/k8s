...
main() {
  ...
  curl -L https://portainer.github.io/k8s/deploy/manifests/agent/portainer-agent-edge-k8s-2.5.0.yaml -o portainer-agent-edge-k8s.yaml || errorAndExit "Unable to download agent manifest"
